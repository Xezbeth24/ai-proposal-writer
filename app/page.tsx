              ...
              {user ? (
                <div className="flex items-center gap-4">
                  <div className="hidden md:flex flex-col items-end">
                    ...
                    <button onClick={logout} className="text-[10px] text-white/40 hover:text-red-400 uppercase">Sign Out</button>
                  </div>
                  <img src={user.photoURL || ""} className="w-10 h-10 rounded-2xl border border-white/10" />
                </div>
              ) : (
